...
The Zephyr kernel is supported on the Sockit Rev ?? development kit, using
...
.. code-block:: console
   ...
   export ALTERA_BASE=/opt/altera_lite/17.1
...
The following works for Ubuntu 16.04:  # TO be tested!
...
configuration file
:file:`soc/nios2/nios2f-zephyr/cpu/sockit_DDR3_Nios.sof`:
